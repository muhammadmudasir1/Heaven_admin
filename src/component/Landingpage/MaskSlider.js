...
const MaskSlider = () => {
  ...
  return (
    <div className='lg:relative px-4'>
        ...
        <>
          <div className="lg:col-span-6 lg:relative my-8">
            ...
            <div className=" relative flex items-center ">
                    ...
                    <SwiperSlide key={Product.Id} className=" relative my-3">
                      ...
                      >
                        ...
                        />
                          ...
                          <div className='w-full h-1/5 z-20 flex justify-center items-center'>

                            <h2 className=' text-4xl text-white font-semibold font-sans'>#{index + 1}</h2>
                          </div>
                          <h2 className='z-10 text-3xl text-white font-semibold font-sans text-center flex-grow flex justify-center px-2'>{Product && Product.product_name}</h2>
                        </div>
                      </div>
                    </SwiperSlide>
                    : <SwiperSlide key={index} className=" relative my-3">
                      ...
                      >
                        <div className='w-full h-full relative flex flex-col justify-center items-center'>
                          ...
                          />
                          <div className={`w-full h-full absolute top-0 ${colors[index]}`} />
                          <h2 className='z-10 text-4xl text-white font-semibold font-sans pb-16'>#{index + 1}</h2>
                          <h2 className='z-10 text-4xl text-white font-semibold font-sans'>{Product && Product.product_name}</h2>
                        </div>
                      </div>
                    </SwiperSlide>
                ))}
              ...
              {width >= 480 && !isEnd && TopFiveProducts.length > slidesToShow ? (
                <div className="text-6xl text-gray-600 hover:text-customBlue cursor-pointer absolute right-16 z-10">
                  <FaAngleRight
                    onClick={(e) => {
