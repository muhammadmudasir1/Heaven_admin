...
const ProductElement = ({ element,selectedList}) => {
...
const ProductFilter = ({ type ,setFilterProduct}) => {
...
productList.map((productList) => {
              return <ProductElement element={productList.product} selectedList={setFilterProduct}/>
            })
          }
