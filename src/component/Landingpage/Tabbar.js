...
const Tabbar = () => {
  ...
  return (
    <div className={isDesktop ? ` bg-white shadow-md shadow-slate-300 w-full cursor-pointer relative ${isSticky ? 'fixednav w-full top-[8vh] lg:top-[10vh] z-[99999]' : ''}` : 'hidden'}>
      {isDesktop ? (
