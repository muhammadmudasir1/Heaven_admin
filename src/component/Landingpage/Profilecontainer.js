    ...
    return (
        <div className='bg-[#00CED1] lg:py-12 py-4 flex lg:flex-row flex-col items-center justify-between p-8  '>
            <div className='flex flex-col justify-start items-start lg:w-9/12 lg:order-1 order-2'>
                <h1 className='text-neutral-800 lg:text-5xl text-xl lg:mt-0 mt-2 font-bold text-center  '>
                    {t('beginnersGuidBannar')}
                </h1>
                <NavLink to={'/ratgaber'} className=' mx-auto text-neutral-800 bg-white rounded-md flex items-center justify-center lg:px-8 px-4 lg:py-4 py-2 lg:mt-14 mt-4 lg:text-2xl text-xl font-medium '>
                    {t('Beginner’s_guide')}
                </NavLink>
            </div>
