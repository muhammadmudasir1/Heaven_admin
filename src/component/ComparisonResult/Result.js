...
const PriceTile = ({ priceData }) => {
  ...
  return (
    <div className='flex   border-2 items-center justify-evenly border-blue-500 rounded-md py-2  my-2 w-full' >
      <div className='w-1/2 justify-center items-center rounded-xl p-1 bg-gray-300'>
          ...
          <div>
            ...
            <div>
              <div className='px-4 py-6  bg-gray-100'>
                <div className=' h-4 rounded-full bg-gray-300 animate-pulse'/>
              </div>
              <div className='px-4 py-6 bg-gray-100'>
                <div className=' h-4 rounded-full bg-gray-300 animate-pulse'/>
              </div>
                        ...
                        >
                          <div className='flex flex-col items-center rounded-lg  h-[300px] w-full overflow-hidden'>
                            ...
                            <div className='px-3'>
                              ...
                              {element.purchaseLinks &&
                                (element.purchaseLinks.length > 2
                                  ? element.purchaseLinks.slice(0, 2)
                                  : element.purchaseLinks
                                ).map((link) => (
                                  <PriceTile key={link.id} priceData={link} />
                                ))}
                            </div>
                          </div>
                        </div>
