                    ...
                    <div className='flex justify-between pr-8'>
                        {
                            isLoading ?
                                ...
                                : <div className='w-full px-8'>
                                    ...
                                    <div className=' w-8/12 h-full pl-4'>
                                        <h1 className=' text-neutral-800 text-2xl font-semibold py-3'>{productName && productName}</h1>
                        ...
                        isLoading ?
                            ...
                            : <>
                                ...
                                <div className=' px-6 py-2 flex flex-col justify-center items-center'>
                                    <h1 className='py-1 text-neutral-800 text-2xl font-semibold '>{productName && productName}</h1>
